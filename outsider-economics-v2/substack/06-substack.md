...
subtitle: "The bank isn't in the money business. The bank is in the permission business."
suggested_tags:
  - outsider economics
  - banking
  - lending circles
...
1. **Stores value** — holds your money so it doesn't get stolen from under your mattress.
2. **Transfers value** — moves money from one person to another.
3. **Allocates capital** — decides who gets loans (and who doesn't).
...
Option A:
The last time I asked a bank for a loan, the branch manager said he'd "run it up the chain."
The chain was in Charlotte. Charlotte said no.
I bought the thing anyway. Borrowed from a friend. Paid him back in six weeks.
Total bank involvement: zero.
[link]

Option B:
The bank isn't in the money business.
The bank is in the permission business.
Here's how to stop asking for permission.
[link]

Option C:
A coordination network does the same three things a bank does — stores value, transfers value, allocates resources.
Without the $260 billion in annual consumer fees.
[link]
