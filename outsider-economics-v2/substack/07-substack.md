...
subtitle: "Every good thing I've ever been part of got ruined the same way: it got too big."
suggested_tags:
  - outsider economics
  - federation
  - Dunbar's number
...
Option A:
Every good thing I've ever been part of got ruined the same way: it got too big.
There's a number where organizations flip from "this is working" to "this is a job."
The number is about 100 people. After that, don't scale. Federate.
[link]

Option B:
Gore-Tex caps every factory at 150 people.
When they need more capacity, they build another factory across the parking lot.
Two plants of 150 outperform one plant of 300. Every time.
[link]

Option C:
The internet isn't one big network run by one big company.
It's millions of small networks connected by shared protocols.
No central authority. No single point of failure.
That's federation. Build your economy the same way.
[link]
