---
title: "What Kills Coordination Systems"
subtitle: "I've watched six coordination networks die. Every failure was preventable."
suggested_tags:
  - outsider economics
  - coordination
  - failure modes
...
"We should get liability insurance."
"We should build an app."
"We should apply for a grant."
"We should become a 501(c)(3)."
...
1. The two people talk.
2. If they can't resolve it, they pick a third person to listen.
3. The third person doesn't decide — they facilitate.
4. If someone needs to leave the network, they leave without drama.
...
Option A:
I've watched six coordination networks die. Not fade — die.
Every failure was preventable. Every one came from the same short list.
Here are the five things that kill them.
[link]

Option B:
The most common way a coordination network dies:
One person builds it around their own energy, doesn't distribute the load, and watches it collapse when they get pulled in another direction.
...
"We should get liability insurance."
"We should build an app."
Every one of these suggestions pulls the network back into the system you built it to route around.
[link]
