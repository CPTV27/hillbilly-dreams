...
const segments = [
  {
    ...
    items: [
      'Deep South Directory (DeepSouthDirectory.com) as distribution vehicle',
      'Free listing → $20/mo dashboard → $99/mo automation',
      'AI business intelligence: QuickBooks sync, daily briefings, marketing automation',
      'Three channels: municipality sponsor, boots on ground, CVB/chamber distributor',
      'No ad spend. Trust networks and neighbors.',
    ],
  },
  {
...
const revenue = [
  ['SMB / Directory (500 users)', '$120,000', '$360,000', '$720,000'],
...
const lastSteps = [
  ...
  { title: 'LEGAL DOCUMENTS', body: 'FERPA DPA and MSA templates with neutral branding. Municipal product sheet with features, pricing, tech diagram.' },
  ...
  { title: 'DEPLOYMENT PLAYBOOKS', body: 'Three written playbooks: CivicX small city (90 days), District safety stack (90 days), State agency pilot (120 days).' },
  { title: 'PRICING MATRICES', body: 'Lock price bands per segment with explicit inclusions/exclusions. No scope creep.' },
  { title: 'REFERENCE WINS', body: 'Big Muddy Inn + Deep South Directory as named case studies. Kiosk mode demonstrated as platform capability. Capture one pilot civic client in the five-county corridor.' },
  ...
  return (
    <div style={S.page}>
      <div style={S.wrap}>
        ...
        <div style={S.hr} />
        <p style={S.body}>Deep South Directory is the first self-serve revenue channel. The $20/mo tier targets every ChatGPT subscriber who runs a small business. The three distribution channels -- municipality sponsor, boots on ground, CVB/chamber -- require zero ad spend. What changes is the story:</p>
        <div style={{ margin: '16px 0' }}>
          <p style={S.body}><strong>Before:</strong>  &quot;We sell software to contractors.&quot;</p>
          <p style={S.body}><strong>After:</strong>   &quot;We are the regional technology provider for the Deep South. The Deep South Directory keeps Main Street commerce visible. Big Muddy keeps culture dollars in the corridor. The municipal and education products keep government technology dollars in-state. All running on the same engine, all keeping money local.&quot;</p>
        </div>
        <p style={S.body}>
