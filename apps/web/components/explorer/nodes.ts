...
export const NODES: Node[] = [
  ...
  { id: 'mbt', label: 'Measurably Better Things', metric: '9 modules · 122 models', status: 'ACTIVE', photo: '/images/ai-corridor/radio-studio.webp', description: 'The Glass Engine. Shared platform powering every brand.', x: 0, y: -150 },
  ...
  { id: 'radio', label: 'Big Muddy Radio', metric: 'Streaming live', status: 'ACTIVE', photo: '/images/dsd/brand-radio.webp', description: 'Mac Mini + Icecast. The voice of the region.', x: 90, y: -350 },
  ...
  { id: 'dsd', label: 'Deep South Directory', metric: 'B2B engagement', status: 'ACTIVE', photo: '/images/dsd/hero-mainstreet.webp', description: 'Directory module — per-engagement configurations (hospitality, real estate, civic).', x: -180, y: 120 },
  ...
  { id: 'gallery', label: 'Chase Pierson Photography', metric: '17,956 photos', status: 'ACTIVE', photo: '/images/gallery/prints/valley-fog-morning.webp', description: 'Fine art + editorial. Tracy curates. The system sells.', x: 300, y: 60 },
];
