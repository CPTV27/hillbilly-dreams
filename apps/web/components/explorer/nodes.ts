...
export const NODES: Node[] = [
  ...
  { id: 'dsd', label: 'Deep South Directory', metric: 'Free – $250/mo', status: 'ACTIVE', photo: '/images/dsd/hero-mainstreet.webp', description: 'AI-managed listings for Main Street businesses.', x: -180, y: 120 },
