...
const SOVEREIGN: EconomicModel = {
  ...
  tagline: '100% margin retention on the HDX Engine — zero capital flight',
  color: C.green400,
  quoteTotal: 11_612,
  platformTake: 0,
  marginRetained: 100,
  leakageItems: [
    { label: 'HDX Platform (local, bundled)', pct: 0, color: C.green400 },
    { label: 'Gemini AI (Google Cloud)', pct: 0, color: C.green400 },
    { label: 'Lead-gen (HDX Media Engine)', pct: 0, color: C.green400 },
    { label: 'Payments (HDX Stripe Connect)', pct: 0, color: C.green400 },
  ],
  terminalLines: [
    '> Scanning site with iPhone 15 Pro LiDAR...',
    '> Processing on HDX / Gemini 2.5 Pro Vision...',
    '',
    '✓ SOVEREIGN PIPELINE — ALL MARGIN RETAINED',
    '  HDX Platform License:      bundled   →  Hillbilly Dreams, Inc.',
    '  AI Scoping (Gemini):       bundled   →  HDX Engine (us-east4)',
    '  Inbound Leads (HDX Media): bundled   →  Local ecosystem',
    '  Payments (Stripe Connect): pass-thru →  Your bank account',
    '',
    '┌─────────────────────────────────────────────┐',
    '│  $11,612.00 quoted                          │',
    '│  – $0 leaves your zip code  (0%)            │',
    '├─────────────────────────────────────────────┤',
    '│  NET RETAINED:  $11,612.00  (100%)          │',
    '│  ✓ Zero capital flight. Full sovereignty.   │',
    '└─────────────────────────────────────────────┘',
  ],
};
