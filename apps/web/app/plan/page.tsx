...
const SECTIONS = [
  {
    ...
    items: [
      ...
      {
        name: 'Product to Platform Mapping',
        desc: '13 modules · 3 revenue tiers · refactor-not-rebuild plan. The canonical strategic doc.',
        href: `${REPO}/docs/PRODUCT_TO_PLATFORM_MAPPING.md`,
        emoji: '◉',
      },
      {
        name: 'Entity Structure',
        desc: 'MBT (parent) · subsidiaries (BMNatchez · BMTouring) · affiliates (Tuthill · Studio C). Ownership + retainer flow.',
        href: `${REPO}/docs/ENTITY_STRUCTURE.md`,
        emoji: '◈',
      },
      {
        name: 'Brand Offerings (Monday session worksheets)',
        desc: '8 brands · what each sells · pricing · modules required. Pre-populated for Chase + Tracy + Amy.',
        href: `${REPO}/docs/brand-offerings/`,
        emoji: '✦',
      },
      {
        name: 'Platform Architecture',
        desc: 'The three-layer model framing — MBT (platform) → Studio C (operator) → Tenants (clients). Sanity is the CMS.',
