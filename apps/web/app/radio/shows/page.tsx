...
const SHOWS = [
  { time: '6:00 AM', name: 'Delta Dawn Report', slug: 'delta-dawn-report', host: 'Delta Dawn', desc: 'Morning news, weather, and river conditions. The region wakes up here.', day: 'Daily' },
