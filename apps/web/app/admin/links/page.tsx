...
// /admin/links — Every link in the ecosystem on one page
...
const SECTIONS = [
  ...
  },
  {
    title: 'Sales & CRM',
    links: [
      { label: 'Clients', href: '/admin/clients', desc: 'DSD client management' },
  ...
  },
  {
    title: 'Production',
    links: [
      { label: 'Studio C Jobs', href: '/admin/studio-c/jobs', desc: 'Video production queue' },
