...
const BRANDS = [
  ...
  },
  {
    ...
    revenue: { current: 24000, projected: 72000, basis: 'Shows running. Door + bar + guarantees. Scaling to 3/wk' },
    multiple: 3,
    assets: 'Venue network, artist pipeline, Blues Room, Sprinter van, liquor license',
    status: 'Revenue — shows + bar active',
  },
  {
  ...
  },
  {
    ...
    revenue: { current: 60000, projected: 150562, basis: 'Rooms booking. Bar revenue (liquor license). Events. Scaling occupancy.' },
    multiple: 2,
    assets: '6 rooms, Blues Room venue, downtown Natchez, liquor license, Cloudbeds PMS',
    status: 'Revenue — rooms + bar + events',
  },
  {
    name: 'Studio C Video',
    domain: 'studiocvideo.com',
    category: 'Production Services',
    revenue: { current: 12000, projected: 96000, basis: 'Photo shoots + video active. Scaling bookings.' },
    multiple: 3,
    assets: '$70-80K equipment, Utopia Studios (Bearsville, NY), multi-cam broadcast',
    status: 'Revenue — shoots booking',
  },
  {
    name: 'Tuthill Design',
    domain: 'tuthilldesign.com',
    category: 'Creative Services',
    revenue: { current: 36000, projected: 60000, basis: 'Active jobs in Woodstock. Realtor clients. Growing pipeline.' },
    multiple: 3,
    assets: 'Real estate vertical, branding portfolio, design system, spatial capture',
    status: 'Revenue — jobs booking',
  },
  {
  ...
  },
  {
    ...
    revenue: { current: 28000, projected: 18000, basis: '$28K back pay receivable + 2% gross/mo ongoing' },
    multiple: 3,
    assets: 'Contractual royalty from Scan2Plan partnership',
    status: 'Revenue — receivable + ongoing',
  },
  {
    name: 'MBT Platform',
