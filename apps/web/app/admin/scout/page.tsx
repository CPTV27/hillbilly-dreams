...
export default function ScoutAndSell() {
  ...
  const S: Record<string, React.CSSProperties> = {
    ...
    captureBtn: { width: '100%', minHeight: 120, padding: '3rem 1rem', background: '#231f1c', border: '2px dashed #c8943e', borderRadius: '14px', color: '#c8943e', fontSize: '1.125rem', fontWeight: 700, cursor: 'pointer', textAlign: 'center', marginBottom: '1rem' },
    ...
    btn: { width: '100%', minHeight: 48, padding: '1.125rem', background: '#c8943e', color: '#1a1816', border: 'none', borderRadius: '10px', fontSize: '1.125rem', fontWeight: 800, cursor: 'pointer' },
