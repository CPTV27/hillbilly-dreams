...
const BRANDS = [
  ...
  { name: 'Big Muddy Records', tier: 'consumer', tierLabel: 'Consumer · Music', line: 'A regional record label releasing artists from the corridor. First Arctic record currently in mix.', revenue: 'Vinyl · digital · streaming · merch' },
  { name: 'Big Muddy Radio', tier: 'consumer', tierLabel: 'Consumer · Broadcast', line: 'Internet radio station with three on-air voices and a programming grid built around the artists we book.', revenue: 'Sponsorships · directory placements · underwriting' },
