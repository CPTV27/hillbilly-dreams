...
const BRANDS = [
  ...
  { name: 'Big Muddy Radio', tier: 'consumer', tierLabel: 'Consumer · Broadcast', line: 'For now: podcasts and curated playlists on Spotify, Apple Podcasts, YouTube Music. May grow into linear streaming radio later.', revenue: 'Show sponsorships · future linear inventory' },
