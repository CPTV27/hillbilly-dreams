export const SESSION_META: Record<number, { title: string; subtitle: string; icon: string }> = {
    ...
    4: { title: "Review Platforms", subtitle: "~1 hour", icon: "⭐" },
    5: { title: "OTA Listings", subtitle: "~2 hours", icon: "🏨" },
    6: { title: "Music & Review System", subtitle: "~1.5 hours", icon: "🎵" },
    7: { title: "Email Setup", subtitle: "~30 min", icon: "✉️" },
};
