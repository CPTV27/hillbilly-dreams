...
This is what makes Bearsville different from Big Muddy. Big Muddy is the road — touring, cities, the corridor between Memphis and New Orleans. Bearsville is the room — where the sound gets made, documented, and sent out into the world.
...
export function getArticlesByRegion(region: 'corridor' | 'louisiana' | 'arkansas-missouri'): Article[] {
  const cityList = region === 'corridor'
    ? CORRIDOR_CITIES
    : region === 'louisiana'
    ? LOUISIANA_CITIES
